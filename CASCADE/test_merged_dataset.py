...
from utils.dataset_merged import MergedDataset  # Asegúrate de tener un dataset combinado
...
parser.add_argument('--volume_path', type=str,
                    default='./data/merged_dataset/test_vol_h5', help='root dir for validation volume data')
parser.add_argument('--dataset', type=str,
                    default='MergedDataset', help='experiment_name')
parser.add_argument('--num_classes', type=int,
                    default=1, help='output channel of network (1 for binary segmentation)')
parser.add_argument('--list_dir', type=str,
                    default='./lists/lists_Merged', help='list dir')
...
# Solo hay una clase, por ejemplo, el objeto de interés
classes = ['object']  # Asegúrate de cambiar esto si tu clase tiene un nombre diferente
...
def inference(args, model, test_save_path=None):
    ...
    # Solo imprimimos las métricas para la única clase
    logging.info('Mean class (1) %s mean_dice %f mean_hd95 %f, mean_jacard %f mean_asd %f' % (classes[0], metric_list[0][0], metric_list[0][1], metric_list[0][2], metric_list[0][3]))
...
if __name__ == "__main__":
    ...
    dataset_config = {
        'MergedDataset': {
            'Dataset': MergedDataset,  # Asegúrate de tener un dataset combinado
